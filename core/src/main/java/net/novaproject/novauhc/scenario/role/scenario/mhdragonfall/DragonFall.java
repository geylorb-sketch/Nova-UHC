...
import net.novaproject.novauhc.scenario.role.scenario.mhdragonfall.dragon.fatalis.Fatalis;
import net.novaproject.novauhc.scenario.role.scenario.mhdragonfall.dragon.whitefatalis.WhiteFatalis;
