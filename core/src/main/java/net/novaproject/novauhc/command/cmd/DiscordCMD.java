...
public class DiscordCMD extends Command {
    ...
    public void execute(CommandArguments args) {
        ...
        TextComponent base = new TextComponent(LangManager.get().get(CommonLang.DISCORD_MESSAGE, player));
        ...
        linkConfig.setHoverEvent(new HoverEvent(
                ...
                new ComponentBuilder(LangManager.get().get(CommonLang.DISCORD_MESSAGE_HOVER, player)).create()
        ));
